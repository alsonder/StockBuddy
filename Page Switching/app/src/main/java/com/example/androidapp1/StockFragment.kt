...
import com.example.androidapp1.databinding.FragmentStockBinding
...
class StockFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnBuy.setOnClickListener {
            findNavController().navigate(R.id.action_stockFragment_to_puppyAttackFragment2)
        }

        binding.btnStockName.setOnClickListener {
            findNavController().navigate(R.id.action_stockFragment_to_puppyAttackFragment2)
        }
